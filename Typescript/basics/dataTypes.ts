...
let mov : Directions = Directions.Down;
console.log(mov);

//3 Heterogenous Enums - can assign mix of string and numeric values in the same enum

//---------------------LITERAL TYPES 
// Literal types allow specifying exact values for variables, function parameters, or properties
...
//-----------------------ARRAYS
let nums: number[] = [1, 2, 3, 10, 23, 12];
let names: Array<string> = ["A", "B"];
let data: (number | string)[] = [1, "two"];
...
let num = nums.slice(1, 3); //create a subarray from index 1 to index 2 (ending index excluded)
...
let order : [number, string, boolean] = [1, "watch", true];
